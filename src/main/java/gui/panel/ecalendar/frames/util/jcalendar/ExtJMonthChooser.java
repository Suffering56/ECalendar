 ...
 */
public class ExtJMonthChooser extends JPanel implements ItemListener,
		ChangeListener {
	...
	private ExtJDayChooser dayChooser;
	private ExtJYearChooser yearChooser;
	private JComboBox comboBox;
	private JSpinner spinner;
	private boolean initialized;
	private boolean localInitialize;

	public ExtJMonthChooser() {
		this(false);
	}
	 ...
	 */
	public ExtJMonthChooser(boolean hasSpinner) {
		super();
	 ...
	 *            the day chooser
	 */
	public void setDayChooser(ExtJDayChooser dayChooser) {
	 ...
	 */
	public void setYearChooser(ExtJYearChooser yearChooser) {
